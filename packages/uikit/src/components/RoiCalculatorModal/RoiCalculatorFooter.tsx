    ...
    <>
      {rewardCakePerSecond ? (
        <>
          <Text>
            {t(
              "The Multiplier represents the proportion of BTAF rewards each farm receives, as a proportion of the BTAF produced each second."
            )}
          </Text>
          <Text my="24px">
            {" "}
            {t("For example, if a 1x farm received 1 BTAF per second, a 40x farm would receive 40 BTAF per second.")}
          </Text>
