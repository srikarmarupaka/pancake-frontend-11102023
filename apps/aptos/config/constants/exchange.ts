...
import { APT, CE_USDC_MAINNET, L0_USDC, WH_USDC_MAINNET, BTAF, CE_BNB_MAINNET } from 'config/coins'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [L0_USDC[ChainId.MAINNET], BTAF[ChainId.MAINNET], CE_BNB_MAINNET],
  [ChainId.TESTNET]: [L0_USDC[ChainId.TESTNET], BTAF[ChainId.TESTNET], CE_BNB_MAINNET],
}
