...
const BTAF = new ERC20Token(56, '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82', 18, 'BTAF', 'BTAFSwap Token')
...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [CurrencyAmount.fromRawAmount(BTAF, ONE), CurrencyAmount.fromRawAmount(BUSD, ONE), '1'],
    [CurrencyAmount.fromRawAmount(BTAF, FIVE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '1'],
    [CurrencyAmount.fromRawAmount(BTAF, ONE), CurrencyAmount.fromRawAmount(BUSD, FIVE), '5'],
    [CurrencyAmount.fromRawAmount(BTAF, FIVE), CurrencyAmount.fromRawAmount(BUSD, ONE), '0.2'],
    ...
    [CurrencyAmount.fromRawAmount(BTAF, ZERO), CurrencyAmount.fromRawAmount(BUSD, ONE), undefined],
    [CurrencyAmount.fromRawAmount(BTAF, ONE), CurrencyAmount.fromRawAmount(BUSD, ZERO), undefined],
