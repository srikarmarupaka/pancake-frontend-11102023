...
const SetPositionCard: React.FC<React.PropsWithChildren<SetPositionCardProps>> = ({
  ...
  const { isVaultApproved, setLastUpdated } = useCakeApprovalStatus(token.symbol === 'BTAF' ? predictionsAddress : null)
  ...
  const handleEnterPosition = async () => {
    ...
    const args = token.symbol === 'BTAF' ? [epoch, valueAsBn.toString()] : [epoch]
