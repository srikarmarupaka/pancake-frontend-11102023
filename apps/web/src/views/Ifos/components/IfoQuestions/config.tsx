...
const config = [
  {
    ...
    description: [
      ...
      <Trans>
        In the Public Sale, everyone with an active Btaf profile can commit. However the maximum amount of BTAF
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active Btaf Profile in order to participate.</Trans>,
    ],
  },
  {
