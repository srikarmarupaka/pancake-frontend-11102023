...
const ButtonMenu: React.FC<React.PropsWithChildren<ButtonMenuProps>> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    t(
      'Your chance of winning is proportional to the BTAF you deposit relative to the total BTAF deposit for Pottery. Currently, there is a cap to the total BTAF deposit size during the beta release.',
    ),
    {
      placement: 'top-end',
      tooltipOffset: [20, 10],
