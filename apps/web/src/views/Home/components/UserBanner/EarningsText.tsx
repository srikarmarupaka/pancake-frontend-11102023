...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BTAF pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BTAF pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BTAF pool', data)
  }
