...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master BTAF chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of BTAF.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's BTAF)`,
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of BTAFSwap',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chef’s',
  'Latest News about BTAFSwap and more!',
]
