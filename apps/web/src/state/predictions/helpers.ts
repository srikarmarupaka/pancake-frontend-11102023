...
export const transformBetResponse = (tokenSymbol) =>
  tokenSymbol === 'BTAF' ? transformBetResponseCAKE : transformBetResponseBNB

export const transformUserResponse = (tokenSymbol) =>
  tokenSymbol === 'BTAF' ? transformUserResponseCAKE : transformUserResponseBNB
...
export const getTotalWon = async (): Promise<{ totalWonBNB: number; totalWonCAKE: number }> => {
  ...
  const totalWonCAKE = getTotalWonMarket(CAKEMarket, 'BTAF')
